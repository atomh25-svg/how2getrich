...
export function PageLayout({
  ...
  return (
    <main className="relative min-h-screen w-full overflow-x-hidden bg-black text-white">
      ...
      <div
        className="relative mx-auto [transform:translate(-9px,-50px)_scale(clamp(0.5,calc(100vw/540),1))] md:[transform:scale(clamp(0.5,calc(100vw/540),1))]"
        style={{
      ...
      >
        ...
        <div className="relative mx-auto flex w-[540px] max-w-full flex-col items-center px-6 pt-[53px] pb-[120px]">
          ...
          <div className="absolute right-full top-[154px] mr-[-30px] hidden md:block">
            <Sidebar />
          </div>
          {children}
        </div>
