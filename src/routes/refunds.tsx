...
export const Route = createFileRoute("/refunds")({
  head: () => ({
    meta: [
      { title: "Refund & Cancellation Policy — how2getrich.online" },
      {
        name: "description",
        content:
          "How to request a refund or cancel your how2getrich.online subscription.",
      },
  ...
  return (
    <PageLayout>
      ...
      <style>{`
        ...
        .privacy-doc ul, .privacy-doc ol { padding-left: 1.5rem !important; margin: 0.5rem 0 !important; }
