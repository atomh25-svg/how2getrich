...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      // Restored the full original font roster — the trim-down to
      // just VT323 + JetBrains Mono changed how the existing typography
      // rendered in subtle ways (some inline `style` declarations cite
      // fonts that aren't VT323/Geist/JetBrains, and the browser was
      // falling back to system defaults that read differently). Loading
      // costs ~250KB extra on cold loads but matches the original look.
      {
        rel: "stylesheet",
